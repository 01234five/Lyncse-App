 ...
 * Use the {@link IncomingRequestsFragment#newInstance} factory method to
...
public class IncomingRequestsFragment extends Fragment {
     ...
     * @return A new instance of fragment IncomingRequestsFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static IncomingRequestsFragment newInstance(String param1, String param2) {
        IncomingRequestsFragment fragment = new IncomingRequestsFragment();
    ...
    private void getElements(View v){
        recyclerView = v.findViewById(R.id.recyclerViewRequestsIncoming);
        flLoad = v.findViewById(R.id.flLoad_IncomingRequest);
        llLoadBottom= v.findViewById(R.id.llLoadBottom_IncomingRequest);
        ivb =v.findViewById(R.id.imageViewDefault_IncomingRequest);
    }

    private void getIdsScroll(View v,String lastKey){
        final FirebaseDatabase database = FirebaseDatabase.getInstance();
        DatabaseReference ref = database.getReference("IncomingRequests/"+userId);
        //GETUID OF GIG--------------------------------------------------------------------------------
    ...
    public void recyclerAdapterInvoke() {
        ...
        adapter = new RecyclerAdapterSmallCardRequests(this.getContext(),  sId, euId, gigId,gigType, status, createdOn,title,price,uriGig,userName,requestIds,uriUser,timeStampFormatted,typeId,duration,durationTime);
