...
import com.lyncseapp.lyncse.adapters.RecyclerAdapterSmallCardRequests;
 ...
 * Use the {@link SentRquestsFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class SentRquestsFragment extends Fragment {
    ...
    RecyclerAdapterSmallCardRequests adapter;
    View vv;
    int pos;
    private int x;
     ...
     * @return A new instance of fragment SentRquestsFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static SentRquestsFragment newInstance(String param1, String param2) {
        SentRquestsFragment fragment = new SentRquestsFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_sent_rquests, container, false);
    }
    @Override
    ...
    private void getElements(View v){
        recyclerView = v.findViewById(R.id.recyclerViewRequestsSent);
        flLoad = v.findViewById(R.id.flLoad_SentRequest);
        llLoadBottom= v.findViewById(R.id.llLoadBottom_SentRequest);
        ivb =v.findViewById(R.id.imageViewDefault_SentRequest);
    }

    private void getIdsScroll(View v,String lastKey){
        final FirebaseDatabase database = FirebaseDatabase.getInstance();
        DatabaseReference ref = database.getReference("OutgoingRequests/"+userId);
        //GETUID OF GIG--------------------------------------------------------------------------------
    ...
    public void getRequestInfo(View v,int reqSize){
        refs = database.getReference("Requests");
            ...
            refs.child(requestIds.get(pos)).addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot snapshot) {
                    ...
                    if (userRequests != null) {
                        ...
                        if(userRequests.status.equals("Requesting"))
                        {
                            typeId.add(0);
    ...
    public void getCreatorProfileUri(){
//TOO SLOW
        refs = database.getReference("Users");
        for (int i = 0; i < requestIds.size(); i++) {
            refs.child(sId.get(i)).addListenerForSingleValueEvent(new ValueEventListener() {
                @Override
                public void onDataChange(@NonNull DataSnapshot snapshot) {
                    ...
                    if (userProfile != null) {
                        ...
                        System.out.println(userProfile.uriProfile);
...
System.out.println(typeId);
        ...
        adapter = new RecyclerAdapterSmallCardRequests(this.getContext(),  sId, euId, gigId,gigType, status, createdOn,title,price,uriGig,creatorName,requestIds,uriCreator,timeStampFormatted,typeId,duration,durationTime);
