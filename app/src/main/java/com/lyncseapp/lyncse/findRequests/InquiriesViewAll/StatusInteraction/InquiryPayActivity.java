...
public class InquiryPayActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_inquiry_pay);
    ...
    private void getElements(){
        llMain=findViewById(R.id.llMain_InquiryPayActivity);
        flLoad=findViewById(R.id.flLoad_InquiryPayActivity);
        payWithStripeButton=findViewById(R.id.requestPay_Pay_with_stripeInquiry);
        tvTitle= findViewById(R.id.gigInfoRecyclerRequestGigReviewInquiryPayActivity);
        tvPrice=findViewById(R.id.textViewPriceRecyclerRequestGigReviewInquiryPayActivity);
        ivPic=findViewById(R.id.imageView2GigImageRequestGigReviewInquiryPayActivity);
        tv1=findViewById(R.id.textViewCreatorRequestGigReviewInquiryPayActivity);
        tv2=findViewById(R.id.textViewInstrunction2RequestGigReviewInquiryPayActivity);
        tvMe=findViewById(R.id.textViewEURequestGigReviewInquiryPayActivity);
        bb=findViewById(R.id.imageButtonInquiryPayActivity);
    }
    ...
    private void stripeCreateIntent(){
        ...
        FirebaseFunctions.getInstance("us-central1") // Optional region: .getInstance("europe-west1")
                .getHttpsCallable( "stripePaymentIntentInquiry")
    ...
    private void onPaymentSheetResult(final PaymentSheetResult paymentSheetResult) {
        if (paymentSheetResult instanceof PaymentSheetResult.Canceled) {
            ...
            reference = FirebaseDatabase.getInstance().getReference("Inquiries/"+reqId+"/uStatus");
            ...
            Intent intent = new Intent(InquiryPayActivity.this, PaymentCompletedActivity.class);
