...
import com.lyncseapp.lyncse.findRequests.InquiriesViewAll.StatusInteraction.InquiryAcceptActivity;
import com.lyncseapp.lyncse.findRequests.InquiriesViewAll.StatusInteraction.InquiryPayActivity;


import java.util.List;

public class RecyclerInquiriesView extends RecyclerView.Adapter {
    List<String> userId;
    List<String> euId;
    List<String> gigId;
    List<String> status;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder (@NonNull ViewGroup
        ...
        if(viewType == 1) {
            ...
            RecyclerInquiriesView.ViewHolder1 viewHolder1 = new RecyclerInquiriesView.ViewHolder1(view);
            return viewHolder1;
            ...
            RecyclerInquiriesView.ViewHolderSendPayment viewHolderSendPayment = new RecyclerInquiriesView.ViewHolderSendPayment(view);
            ...
            RecyclerInquiriesView.ViewHolderAwaitingPayment viewHolderAwaitingPayment = new RecyclerInquiriesView.ViewHolderAwaitingPayment(view);
            return viewHolderAwaitingPayment;

        } else if(viewType == 99) {
        LayoutInflater layoutInflater = LayoutInflater.from(parent.getContext());
        View view = layoutInflater.from(parent.getContext()).inflate(R.layout.recycler_small_card_requests, parent, false);
        RecyclerInquiriesView.ViewHolderCompleted viewHolderCompleted = new RecyclerInquiriesView.ViewHolderCompleted(view);
        return viewHolderCompleted;
        }
        else {
            LayoutInflater layoutInflater = LayoutInflater.from(parent.getContext());
            View view = layoutInflater.from(parent.getContext()).inflate(R.layout.recycler_small_card_requests, parent, false);
            RecyclerInquiriesView.ViewHolder viewHolder = new RecyclerInquiriesView.ViewHolder(view);
            return viewHolder;
        }
    ...
    public void onBindViewHolder (@NonNull RecyclerView.ViewHolder holder,
        ...
        if(typeId.get(position)==1){
            RecyclerInquiriesView.ViewHolder1 vh1 = (RecyclerInquiriesView.ViewHolder1) holder;
            ...
            vh1.textViewDuration.setText(duration.get(position));
            vh1.textViewDurationTime.setText(durationTime.get(position));
            ...
            RecyclerInquiriesView.ViewHolderSendPayment vhsp = (RecyclerInquiriesView.ViewHolderSendPayment) holder;
            ...
            vhsp.textViewDuration.setText(duration.get(position));
            vhsp.textViewDurationTime.setText(durationTime.get(position));
        ...
        {
            RecyclerInquiriesView.ViewHolderAwaitingPayment vhap = (RecyclerInquiriesView.ViewHolderAwaitingPayment) holder;
            ...
            vhap.textViewDuration.setText(duration.get(position));
            vhap.textViewDurationTime.setText(durationTime.get(position));
            ...
            RecyclerInquiriesView.ViewHolderCompleted vh = (RecyclerInquiriesView.ViewHolderCompleted) holder;
            ...
            vh.textViewDuration.setText(duration.get(position));
            vh.textViewDurationTime.setText(durationTime.get(position));
        ...
        {
            RecyclerInquiriesView.ViewHolder vh = (RecyclerInquiriesView.ViewHolder) holder;
            vh.imageView.setImageDrawable(null);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            super(itemView);
            textViewDuration=itemView.findViewById(R.id.textViewDurationRecyclerSmallCardRequests);
            textViewDurationTime=itemView.findViewById(R.id.textViewDurationTimeRecyclerSmallCardRequests);
            ...
            cl.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    {
                        Intent intent = new Intent(v.getContext(), InquiriesChatActivity.class);
                        intent.putExtra("REQ_DURATION", textViewDuration.getText().toString());
                        intent.putExtra("REQ_DURATIONTIME", textViewDurationTime.getText().toString());
...
public class ViewHolderAwaitingPayment extends RecyclerView.ViewHolder {
    ...
    public class ViewHolder1 extends RecyclerView.ViewHolder {
        ...
        public ViewHolder1(@NonNull View itemView) {
            super(itemView);
            textViewDuration=itemView.findViewById(R.id.textViewDurationRecyclerSmallCardRequestsAccept);
            textViewDurationTime=itemView.findViewById(R.id.textViewDurationTimeRecyclerSmallCardRequestsAccept);
            ...
            b.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent intent = new Intent(v.getContext(), InquiryAcceptActivity.class);
                    intent.putExtra("REQ_DURATION", textViewDuration.getText().toString());
                    intent.putExtra("REQ_DURATIONTIME", textViewDurationTime.getText().toString());
                    intent.putExtra("REQ_ID", textViewListIds.getText().toString());
                    intent.putExtra("REQ_TITLE",textView.getText().toString());
                    intent.putExtra("REQ_PRICE",textView2.getText().toString());
    ...
    public class ViewHolderSendPayment extends RecyclerView.ViewHolder {
        ...
        public ViewHolderSendPayment(@NonNull View itemView) {
            super(itemView);
            textViewDuration=itemView.findViewById(R.id.textViewDurationRecyclerSmallCardRequestsP);
            textViewDurationTime=itemView.findViewById(R.id.textViewDurationTimeRecyclerSmallCardRequestsP);
            ...
            b.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent intent = new Intent(v.getContext(), InquiryPayActivity.class);
                    intent.putExtra("REQ_DURATION", textViewDuration.getText().toString());
                    intent.putExtra("REQ_DURATIONTIME", textViewDurationTime.getText().toString());
                    intent.putExtra("REQ_ID", textViewListIds.getText().toString());
                    intent.putExtra("REQ_TITLE",textView.getText().toString());
