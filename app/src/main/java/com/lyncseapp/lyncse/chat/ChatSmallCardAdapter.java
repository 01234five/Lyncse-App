...
public class ChatSmallCardAdapter extends RecyclerView.Adapter<ChatSmallCardAdapter.ViewHolder> {
    ...
    public ChatSmallCardAdapter(Context context, List<String> data, List<String> listPrices, List<String> listUri,List<String> listIds,List<String> listCreatorIds,List<String> listType) {
    ...
    @NonNull
    @Override
    public ChatSmallCardAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {

        LayoutInflater layoutInflater = LayoutInflater.from(parent.getContext());
        View view = layoutInflater.inflate(R.layout.recycler_small_card,parent,false );
        ChatSmallCardAdapter.ViewHolder viewHolder = new ChatSmallCardAdapter.ViewHolder(view);
        return viewHolder;

    }

    @Override
    public void onBindViewHolder(@NonNull ChatSmallCardAdapter.ViewHolder holder, int position) {
        ...
        holder.cv.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Intent intent = new Intent(v.getContext(), ChatViewPost.class);
