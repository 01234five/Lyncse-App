 ...
 * Use the {@link CreatedViewOutsideFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class CreatedViewOutsideFragment extends Fragment {
    ...
    public CreatedViewOutsideFragment() {
     ...
     * @return A new instance of fragment CreatedViewOutsideFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static CreatedViewOutsideFragment newInstance(String param1, String param2) {
        CreatedViewOutsideFragment fragment = new CreatedViewOutsideFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_created_view_outside, container, false);
    }
    @Override
    ...
    private void getElements(View v){
        recyclerView = v.findViewById(R.id.recyclerCreatedOutsideFragment);
        flLoadCenter = v.findViewById(R.id.flLoad_ViewCreatedOutside);
        flLoadBottom = v.findViewById(R.id.llLoadBottom_ViewCreatedOutside);
        ivDefault = v.findViewById(R.id.imageViewDefault_ViewCreatedOutside);
    }
