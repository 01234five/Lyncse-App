...
public class GigSelectedSearch extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gig_selected_search);
        ...
        if(creatorId.equals(authUserId) ){
            View v = findViewById(R.id.btnRequestGigGigSelectedSearch);
    ...
    private void getEUInfo(){
        ...
        reference.child(authUserId).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            @Override
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(GigSelectedSearch.this,"Something wrong happened!", Toast.LENGTH_LONG).show();
            }
        });
    }
    ...
    private void getViewElements(){
        titleTextView=(TextView) findViewById(R.id.titleGigSelectedSearch);
        gigInfoTextView=(TextView) findViewById(R.id.gigInfoGigSelectedSearch);
        gigBanner=findViewById(R.id.imageViewGigSelectedSearch);
        nameTextView=(TextView) findViewById(R.id.nameGigSelectedSearch);
        profilePic=findViewById(R.id.profilePicGigSelectedSearch);
        distanceAway=findViewById(R.id.textView7LocationGigSelectedSearch);

        price1TextView = (TextView) findViewById(R.id.editTextLengthInfo1PriceGigSelectedSearch);
        duration1TextView = (TextView) findViewById(R.id.editTextLengthInfo1LengthGigSelectedSearch);
        time1TextView = (TextView) findViewById(R.id.textViewTime1GigSelectedSearch);
        toggleButtonGig1 = (ToggleButton) findViewById((R.id.toggleButtonGig1GigSelectedSearch));

        price2TextView = (TextView) findViewById(R.id.editTextLengthInfo2PriceGigSelectedSearch);
        duration2TextView = (TextView) findViewById(R.id.editTextLengthInfo2LengthGigSelectedSearch);
        time2TextView = (TextView) findViewById(R.id.textViewTime2GigSelectedSearch);
        toggleButtonGig2 = (ToggleButton) findViewById((R.id.toggleButtonGig2GigSelectedSearch));

        price3TextView = (TextView) findViewById(R.id.editTextLengthInfo3PriceGigSelectedSearch);
        duration3TextView = (TextView) findViewById(R.id.editTextLengthInfo3LengthGigSelectedSearch);
        time3TextView = (TextView) findViewById(R.id.textViewTime3GigSelectedSearch);
        toggleButtonGig3 = (ToggleButton) findViewById((R.id.toggleButtonGig3GigSelectedSearch));

        request = (Button) findViewById(R.id.btnRequestGigGigSelectedSearch);

        clMessage=findViewById(R.id.linearLayOutProfileGigSelectedSearch);
        ibChat=(ImageButton) findViewById(R.id.imageButton2ChatGigSelectedSearch);
        fusedLocationProviderClient = LocationServices.getFusedLocationProviderClient(this);
        bb=findViewById(R.id.imageButtonGigSelectedSearch);
    }
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if(userProfile !=null){
                    ...
                    if(userProfile.uriProfile.equals("Default")){
                            Glide.with(GigSelectedSearch.this).load(R.drawable.ic_baseline_android_200).into(profilePic);
                    }else {
                        Glide.with(GigSelectedSearch.this)
    ...
    private void startActivity(){
        if(optionSelectedStatus.equals("INACTIVE")){
            Toast.makeText(GigSelectedSearch.this,"Inactive option",Toast.LENGTH_LONG).show();
            return;
        }
        Intent intent = new Intent(GigSelectedSearch.this,RequestGigReview.class);
