...
public class RecyclerAdapterChatGigMessages extends RecyclerView.Adapter{
    List<String> message;
    List<Long> time;
    ...
    public RecyclerAdapterChatGigMessages(Context context,  List<String> message, List<Long> time,List<String> profilePic,List<String> name,List<Integer> type) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        if(viewType == 0) {
            ...
            RecyclerAdapterChatGigMessages.ViewHolder1 viewHolder1 = new RecyclerAdapterChatGigMessages.ViewHolder1(view);
            return viewHolder1;
        }else {
            LayoutInflater layoutInflater = LayoutInflater.from(parent.getContext());
            View view = layoutInflater.from(parent.getContext()).inflate(R.layout.recycler_chat_request_their_message, parent, false);
            RecyclerAdapterChatGigMessages.ViewHolder2 viewHolder2 = new RecyclerAdapterChatGigMessages.ViewHolder2(view);
            return viewHolder2;
        }
            ...
            ll.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    if(x==false) {
                        ...
                        // long lg;
                        // lg= Long.parseLong(textViewTime.getText().toString());
                        // System.out.println(lg + " " + textViewTime.getText().toString());
